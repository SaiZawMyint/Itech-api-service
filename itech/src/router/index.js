...
import FacebookHome from '@service/APITools/facebook/FacebookHome.vue'
        ...
        children: [{
            ...
            },
            {
                ...
                children: [{
                    ...
                    {
                        path: 'service/:spreadsheetId?',
                        'name': 'itech.spreadsheet.sheets',
                        component: SheetLists,
                    },
            ...
            },
            {
                ...
                children: [{
                    ...
                    {
                        path: 'service/:driveFolderId?',
                        'name': 'itech.drive.files',
                        component: DriveFileLists,
                        children: [{
                            path: 'open/:fileId',
                            name: 'open-file',
                            component: OpenFile
